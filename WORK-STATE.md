...
- The corresponding News story uses the user-supplied Kunming-Montreal Global Biodiversity Framework visual identity as an editorial illustration, with CBD attribution and the explicit non-affiliation boundary in the story copy. It does not use the BHOC Initiative mark.
