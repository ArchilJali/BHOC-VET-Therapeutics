...
export default function renderScienceBridge(data){
  ...
  return '<section class="science-bridge" id="'+esc(data.id)+'" data-block="science-bridge" aria-labelledby="science-title">'+
    '<div class="shell science-grid">'+
      ...
      '<div class="science-claim">'+claimImage+'<div class="science-claim-content"><strong>'+lines(data.claimLines)+'</strong><div class="science-comparison">'+comparison+'</div><p>'+esc(data.caption)+'</p></div></div>'+
    '</div>'+
  '</section>';
}
