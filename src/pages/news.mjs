...
const saxonFeature={
  ...
  title:'25 years after 9/11: the K-9s who worked beside us, and the story of K-9 Saxon.',
  text:"Twenty-five years after 9/11, BHOC Veterinary remembers the search-and-rescue K-9 teams who worked beside first responders at the World Trade Center. On September 19, 2001, HHS reported as many as 300 rescue dogs at the site and 13 Veterinary Medical Assistance Team veterinarians providing emergency care for fatigue, lacerations, smoke and dust inhalation, eye irritation, dehydration and exhaustion. The available 9/11 record does not document Oxyglobin administration at Ground Zero. Less than a year later, on August 22, 2002, Fresno Police K-9 Saxon was shot at point-blank range and critically injured. In a letter reproduced in Biopure's 2002 Annual Report, Police Chief Jerry Dyer wrote that discussions with veterinarian Dr. Roger Gfeller left no doubt, in their view, about the pivotal role Oxyglobin played in saving Saxon's life. Fresno Police later established the Saxon Award in his honor.",
  why:'They help us when human lives are at risk. Saxon’s case shows why working-dog emergency medicine also needs tools ready when their own oxygen delivery is compromised.',
...
const enrichPage=page=>({...page,stories:page.stories.map(story=>story.id==='k9-saxon-oxyglobin-2002'?{...story,...saxonFeature,image:story.image||saxonVisual,credit:story.credit||saxonCredit}:story)});
