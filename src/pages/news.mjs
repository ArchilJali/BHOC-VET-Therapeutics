...
.story-media{position:relative;display:block;min-height:154px;overflow:hidden;background:#edf2ef;margin:0}.story-media img{width:100%;height:100%;min-height:154px;object-fit:cover;display:block;transition:transform .2s ease}.conservation-story:hover .story-media img{transform:scale(1.015)}.story-media-logo{display:flex;align-items:center;justify-content:center;padding:20px;background:#fff}.story-media-logo img{width:100%;height:auto;min-height:0;max-height:100%;object-fit:contain!important;transform:none!important}.conservation-story:hover .story-media-logo img{transform:none}
...
.story-copy h3{margin:0 0 5px;font-size:clamp(17px,1.6vw,21px);line-height:1.16;letter-spacing:-.25px;color:var(--ink)}.story-copy p{margin:0;color:var(--muted);font-size:11.5px;line-height:1.48;display:-webkit-box;-webkit-line-clamp:4;-webkit-box-orient:vertical;overflow:hidden}.story-footer{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:auto;padding-top:8px}.story-link{font-size:10px;font-weight:800;color:var(--teal);text-decoration:none}.story-link:hover{text-decoration:underline}.story-why{font-size:8.5px;color:#738083;text-align:right}
