...
.conservation-story-document,.conservation-story-featured.conservation-story-document{grid-template-columns:1fr;border-color:#d9c1b1}
...
.story-media{position:relative;display:block;min-height:260px;overflow:hidden;background:#edf2ef;margin:0}.story-media img{width:100%;height:100%;min-height:260px;object-fit:contain;display:block;transition:none}.conservation-story-featured .story-media,.conservation-story-featured .story-media img{min-height:390px}.conservation-story:hover .story-media img{transform:none}
...
@media(max-width:920px){.seo-context{grid-template-columns:145px minmax(0,1fr)}.seo-context-links{grid-column:2;display:flex;flex-wrap:wrap;column-gap:18px}.conservation-story,.conservation-story-featured{grid-template-columns:minmax(225px,35%) minmax(0,1fr)}.conservation-story-document,.conservation-story-featured.conservation-story-document,.conservation-story-no-media,.conservation-story-featured.conservation-story-no-media{grid-template-columns:1fr}.conservation-story-featured .story-media,.conservation-story-featured .story-media img{min-height:350px}.conservation-story-featured .story-media-portrait img{min-height:0}.conservation-story-featured .story-media-document,.conservation-story-featured .story-media-document img{min-height:0}.story-copy{padding:24px}.conservation-story-featured .story-copy h3{font-size:30px}}
