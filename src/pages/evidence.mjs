...
export default page=>`<main id="main" class="subpage-main publications-page evidence-page">
  ...
  <section id="fda-field-trial" class="regulatory-feature" aria-labelledby="fda-field-trial-heading"><div class="regulatory-marker"><span>${esc(page.spotlight.marker)}</span><small>${esc(page.spotlight.markerLabel)}</small></div><div class="regulatory-copy"><span class="page-eyebrow">${esc(page.spotlight.eyebrow)}</span><h2 id="fda-field-trial-heading">${esc(page.spotlight.title)}</h2><p><strong>${esc(page.spotlight.detail)}</strong></p><p>${esc(page.spotlight.secondary)}</p><p>${esc(page.spotlight.endpoint)}</p><p>${esc(page.spotlight.trial)}</p><div class="inline-actions">${page.spotlight.links.map(inlineLink).join('')}</div></div></section>
