...
assert.match(news,/assets\/news\/wodan-bellwether-no-49-page-23\.webp/,'Wodan story uses the local documentary source image');
assert.match(news,/Vet-case-K19-Wodan-Oxyglobin\.html/,'Wodan story routes to Evidence K19');
assert.match(news,/repository\.upenn\.edu\/bitstreams\/77cb33be-84e9-4823-8648-5e76e24ff719\/download/,'Wodan story preserves the original Bellwether source');
